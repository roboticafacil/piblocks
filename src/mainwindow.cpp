...
void MainWindow::actionInsertLanguage() {
    // Set language in Facilino
    QString jsLanguage = QString("var FacilinoLanguage = '%1';").
...
void MainWindow::on_donation_released()
{
    QString link = "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=BF67GJNW6MHXS";
